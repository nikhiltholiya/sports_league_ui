...
class _SubmitScoreDetailsState extends State<SubmitScoreDetails> with isInternetConnection {
                                      ...
                                      return Padding(
                                        ...
                                        child: DropDownView(
                                          ...
                                          onValueChange: (value) {
                                            ...
                                            var data =
                                                _leaguesList!.where((element) => element.node?.league?.name == value);
                                            // print('Selected -- $data');
                                    ...
                                    return ElevatedButtons(
                                      ...
                                      onClick: () {
                                        matchGameStatus = selectedMatchStatus.contains(true)
                                            ? matchStatus[selectedMatchStatus.indexOf(true)]
                                                .toString()
                                                .trim()
                                                .toLowerCase()
                                            : '';
                                        matchWinnerName = selectedPlayer.contains(true)
                                            ? displayPlayer[selectedPlayer.indexOf(true)]
                                                .toString()
                                                .trim()
                                                .toLowerCase()
                                            : '';
                                        ...
                                        Map<String, dynamic> passMap = {
                                          ...
                                          'startDate':
                                              convertDateYYYYMMDD(matchDate ?? DateTime.now().toString(), null),
                                          ...
                                          'winnerOne': matchGameStatus != 'draw'
                                              ? players[selectedPlayer.indexOf(true)]?.userId
                                              : '',
