...
import 'package:flutter_datetime_picker_plus/flutter_datetime_picker_plus.dart'
    as dpicker; //20230530 Resolve error
...
class _SubmitScoreDetailsState extends State<SubmitScoreDetails>
  ...
  void initState() {
    ...
    player1 =
        UserNode.fromJson(jsonDecode(SharedPreferencesUtils.getUserData!));
  ...
  Widget build(BuildContext context) {
    debugPrint(
        '${SubmitScoreDetails.path} * matchGameType -- ${matchGameType} -- $selectedGameType');
                    ...
                    builder: (result, {fetchMore, refetch}) {
                      ...
                      if (!isLoaded!) {
                        ...
                        for (var data in players)
                          displayPlayer.add(data?.firstName);
                                    ...
                                    children: [
                                      AppChip(
                                        ...
                                        onChipTap: () {
                                          dpicker.DatePicker.showDatePicker(
                                            ...
                                            onChanged: (date) {
                                              debugPrint(
                                                  '${SubmitScoreDetails.path}  * change $date');
                                            },
                                            onConfirm: (date) {
                                              matchDate = date.toString();
                                              setState(() {});
                                              debugPrint(
                                                  '${SubmitScoreDetails.path}  * confirm $date');
                                            },
                                      ...
                                      AppChip(
                                        ...
                                        Label: convertTime(
                                            ...
                                            null),
                                        onChipTap: () {
                                          dpicker.DatePicker.showTime12hPicker(
                                            context,
                                            theme: dpicker.DatePickerTheme(
                                              backgroundColor: aWhite,
                                              itemStyle:
                                            ...
                                            onChanged: (date) {
                                              debugPrint(
                                                  '${SubmitScoreDetails.path}  * changeTime $date');
                                            },
                                            onConfirm: (date) {
                                              matchTime = date.toString();
                                              setState(() {});
                                              debugPrint(
                                                  '${SubmitScoreDetails.path}  * confirmTime $date');
                                            },
                                ...
                                Mutation(
                                  options: MutationOptions(
                                    ...
                                    onError: (OperationException? error) {
                                      debugPrint(
                                          '${SubmitScoreDetails.path}  * erroR -- $error');
                                      // Text('$error');
                                    },
                                    ...
                                    onCompleted: (dynamic resultData) {
                                      ...
                                      debugPrint(
                                          '${SubmitScoreDetails.path}  * Result -- $resultData');
                                  ...
                                  builder: (RunMutation _submitScore,
                                    ...
                                    return ElevatedButtons(
                                      ...
                                      fontSize: 16,
                                      onClick: () {
                                        matchGameStatus = selectedMatchStatus
                                                .contains(true)
                                        ...
                                        matchWinnerName =
                                            selectedPlayer.contains(true)
                                                ...
                                                : '';
                                        matchGameType =
                                            selectedGameType.contains(true)
                                        ...
                                        if (matchGameStatus != 'draw' &&
                                            matchWinnerName!.isEmpty) {
                                          return ScaffoldMessenger.of(context)
                                              .showSnackBar(SnackBar(
                                        ...
                                        debugPrint(
                                            '${SubmitScoreDetails.path}  * passMap $passMap');
