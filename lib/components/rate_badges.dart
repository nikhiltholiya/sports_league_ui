  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: ShapeDecoration(
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(5.0), side: BorderSide.none),
          color: aGreen),
      ...
      child: Text(
        ...
        maxLines: 1,
        style:
            TextStyle(letterSpacing: 1.0, fontSize: widget.textSize!, fontWeight: FontWeight.bold, color: Colors.white),
      ),
    );
  }
}
